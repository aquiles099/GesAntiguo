...
export class TablaComponent implements OnInit {
  ...
  nuevo(){
    this.router.navigate([`/medium/home/proyectos/${this.id_proyecto}/gmao/configuracion/tipos-incidencias-ordenes/nuevo`]);
  }
  ver(item){
   localStorage.setItem('tipo_incidencias_ver',JSON.stringify(item));
   this.router.navigate([`/medium/home/proyectos/${this.id_proyecto}/gmao/configuracion/tipos-incidencias-ordenes/ver`]);
  }
  buscar(item){
    console.log(item);
    if (item==''){
