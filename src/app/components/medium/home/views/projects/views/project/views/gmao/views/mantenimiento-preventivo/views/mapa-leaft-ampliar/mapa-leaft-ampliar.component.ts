...
import { Control, Draw, DrawEvents, drawLocal, DrawMap, featureGroup, FeatureGroup, GeometryUtil, icon, latLng, latLngBounds, LatLngExpression, LatLngTuple, Marker, marker, TileLayer, tileLayer, Toolbar, Util, Polyline, Polygon, MapOptions, LatLngBounds } from 'leaflet';import proj4 from 'proj4';
...
@Component({
  selector: 'app-mapa-leaft-ampliar',
  templateUrl: './mapa-leaft-ampliar.component.html',
  styleUrls: ['./mapa-leaft-ampliar.component.css']
})
export class MapaLeaftAmpliarComponent implements AfterViewChecked, OnDestroy{
