...
@Component({
  selector: 'feature-legend',
  templateUrl: './feature-legend.component.html',
  styleUrls: ['./feature-legend.component.css','../../../../../../../themes/styles/map-tool-bar.scss']
})
export class FeatureLegendComponent extends HideableSectionComponent
{
