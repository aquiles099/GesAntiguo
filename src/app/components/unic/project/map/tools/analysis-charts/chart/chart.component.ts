import { Component, Input, HostListener, ChangeDetectorRef, AfterViewInit } from '@angular/core';
...
export class ChartComponent extends BaseChart implements AfterViewInit
{
  @Input()
