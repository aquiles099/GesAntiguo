...
export class ExportViewComponent extends HideableSectionComponent 
{
  ...
  private async addChartsImages():Promise<void>
  {
    ...
    for(let chart of charts)
    {
      ...
      const  imgSrc = chart instanceof ChartComponent ?
  ...
  private async getHighchartsImage(chart:ChartComponent):Promise<string>
  {
    const requestBody = {
