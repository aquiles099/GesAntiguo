...
import { Map, Polygon, CircleMarker, Polyline } from 'leaflet';
...
@Component({
  ...
  styleUrls: ['./feature-table.component.css','../../../../../../../themes/styles/map-tool-bar.scss']
})
export class FeatureTableComponent  extends HideableSectionComponent implements OnDestroy
{
  @Input()
  public map:Map;
  ...
  public async showDataTable():Promise<void>
  {
    try
    {
      ...
      const features = this.selectedFileLayer.file.getContent().features;
